...
KubeAI supports the following private model repositories, and different authentication metod.
...
You can also pass credentials using env and envFrom in the model spec.
This is an example how to confiure an S3 self managed instance with env and envFrom.
...
spec:
  ...
  adapters: # <--
  - name: llama-famiglia
    url: s3://models/aixpa_amicifamiglia_short_prompt
  engine: VLLM
  env:
