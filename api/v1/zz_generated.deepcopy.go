...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CHWBL) DeepCopyInto(out *CHWBL) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CHWBL.
func (in *CHWBL) DeepCopy() *CHWBL {
	if in == nil {
		return nil
	}
	out := new(CHWBL)
