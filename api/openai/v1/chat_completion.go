...
// ChatMessageContent is a struct that represents a part of a chat message content.
// It can be either a string or an array of string parts.
//
//easyjson:skip
type ChatMessageContent struct {
	// String should not be set when Array is set.
	String string
	// Array should not be set when String is set.
...
//		return nil, errors.New("invalid message: Content and MultiContent cannot be set at the same time")
//	}
...
//func (r FinishReason) MarshalEasyJSON(w *jwriter.Writer) {
//	if r == FinishReasonNull || r == "" {
//		w.RawString("null")
//		return
//	}
//	// w.String automatically quotes and escapes the string value.
//	w.String(string(r))
//}
